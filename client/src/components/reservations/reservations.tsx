...
const ReservationCard: FC<ReservationCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <Box bg="var(--bg)" borderRadius="lg" p={4}>
        <Text color="var(--text2)" fontSize="0.78rem" fontWeight={700}>
          利用日時
        </Text>
        <Text
          color="var(--text)"
      ...
      <SimpleGrid columns={{ base: 1, sm: 2 }} gap={3} mt={3}>
        <Box bg="var(--bg)" borderRadius="lg" p={3}>
          <Text color="var(--text2)" fontSize="0.75rem" fontWeight={700}>
            料金
          </Text>
          <Text color="var(--text)" fontSize="0.92rem" fontWeight={700} mt={1}>
        ...
        <Box bg="var(--bg)" borderRadius="lg" p={3}>
          ...
          <Text color="var(--text)" fontSize="0.88rem" fontWeight={700} mt={1}>
            {reservation.id}
          </Text>
        </Box>
      </SimpleGrid>
  ...
  return (
    <Layout title="予約管理" subtitle="予約中・履歴の確認ができます">
      <Box
        ...
        p={{ base: 4, md: 6 }}
      >
        <HStack bg="var(--bg)" borderRadius="xl" gap={1.5} mb={5} p={1.5} width="100%">
          <Button
            bg={tab === "active" ? "var(--surface)" : "transparent"}
            borderRadius="lg"
            boxShadow={tab === "active" ? "0 1px 3px rgba(15, 23, 42, 0.12)" : "none"}
            color={tab === "active" ? "var(--primary)" : "var(--text2)"}
            flex={1}
            fontWeight={800}
          ...
          <Button
            bg={tab === "history" ? "var(--surface)" : "transparent"}
            borderRadius="lg"
            boxShadow={tab === "history" ? "0 1px 3px rgba(15, 23, 42, 0.12)" : "none"}
            color={tab === "history" ? "var(--primary)" : "var(--text2)"}
            flex={1}
            fontWeight={800}
        ...
        {isLoading ? (
          <Box bg="var(--bg)" borderRadius="xl" p={8} textAlign="center">
